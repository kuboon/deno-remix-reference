/**
 * GET / — the app's landing route.
 *
 * On a direct browser load it renders the shell (nav + `<Frame name="content">`),
 * whose content frame re-enters this same route with the `rmx-frame` header to
 * fetch the landing fragment below. Frame requests (server-side resolver or the
