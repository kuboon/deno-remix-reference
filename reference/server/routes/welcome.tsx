/**
 * GET /welcome — landing content shown inside the top page frame.
 *
 * Same intro as the previous `/` page, but rendered without the outer
 * navigation since the shell at `/` provides one above the iframe.
 */

import type { RequestHandler } from "@remix-run/fetch-router";
import { renderLayout } from "../lib/layout.tsx";

export const welcomeRoute: RequestHandler = (_ctx) => {
  return renderLayout(
    "Welcome",
    <main>
